...
QNode::QNode(string nodeId, int level, int x, int y, int width, int height, list<Object*> objs)
{
	this->nodeId = nodeId;
	this->level = level;
...
void QNode::split() {
	...
	list<Object*> objNode1;
	list<Object*> objNode2;
	list<Object*> objNode3;
	list<Object*> objNode4;
	for (auto obj : this->region->getObjs()) {
		switch (this->region->getNumberNodeWhenSplit(obj))
		{
		case NODE1:
