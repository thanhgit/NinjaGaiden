...
Map2::Map2(LPDIRECT3DDEVICE9 _d3ddv, Camera* camera, LPWSTR _spriteSheet, LPWSTR _spriteSheet2, char* _fileName)
	: Map(_d3ddv, camera, _spriteSheet, _spriteSheet2, _fileName)
{
	ReadMap("data/map2/map.txt");
...
void Map2::ReadMap(char* _filename)
{
...
void Map2::ReadRecs(char * _filename)
{
	fstream myfile(_filename, ios::in);
	string line = "";
	int count = 0;
...
void Map2::ReadStatics(char * _filename)
{
	fstream myfile(_filename, ios::in);
	string line = "";
	int count = 0;
...
void Map2::ReadEnemies(char * _fileName)
{
	fstream myfile(_fileName, ios::in);
	string line = "";
	int count = 0;
